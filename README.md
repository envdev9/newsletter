...
### Codzienna dawka .NET, DevOps i AI — zawsze z działającym kodem
...
![Aspire](https://img.shields.io/badge/.NET_Aspire-512BD4?style=for-the-badge)
...
**Jak to działa?** → [`TOPICS.md`](TOPICS.md) (linia redakcyjna) · [`STATE.md`](STATE.md) (postęp per rubryka)
