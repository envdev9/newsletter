...
Trzy metody LINQ na jedno słowo „LEFT" zastąpił jeden operator, a `partial` obejmuje teraz konstruktory i eventy — `LeftJoin`/`RightJoin` i partial members zweryfikowane na SDK 10.
