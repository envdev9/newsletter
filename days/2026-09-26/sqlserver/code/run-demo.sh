...
CONTAINER_NAME="sqlserver-prasowka-qs"
...
run_script 01-create-data.sql
run_script 02-recompile-optimize-for.sql
run_script 03-query-store.sql
run_script 04-force-plan.sql
run_script 05-filtered-index.sql
